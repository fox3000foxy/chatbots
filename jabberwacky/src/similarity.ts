 ...
 *
 * The original Jabberwacky/Cleverbot matching internals were never published.
 * We don't know their exact scoring function - only the documented high-level
 * idea (contextual pattern matching, heuristics for relevance/humor/context
 * fit). What follows is our own reasonable implementation of that idea using
 * standard, well-known techniques (token overlap + bigrams), not a copy of
